...
def preprocess_data(dataset_name: str, bipartite: bool = True, node_feat_dim: int = 172):
    ...
    PATH = '../DG_data/{}.csv'.format(dataset_name)
    OUT_DF = '../processed_data/ml_{}.csv'.format(dataset_name)
    OUT_FEAT = '../processed_data/ml_{}.npy'.format(dataset_name)
    OUT_NODE_FEAT = '../processed_data/ml_{}_node.npy'.format(dataset_name)
...
def check_data(dataset_name: str):
    ...
    """
    # original data paths
    origin_OUT_DF = '../DG_data/ml_{}.csv'.format(dataset_name)
    origin_OUT_FEAT = '../DG_data/ml_{}.npy'.format(dataset_name)
    origin_OUT_NODE_FEAT = '../DG_data/ml_{}_node.npy'.format(dataset_name)
